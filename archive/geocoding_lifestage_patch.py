"""
archive.geocoding_lifestage_patch.py  —  BioTrace v5.4
────────────────────────────────────────────────────────────────────────────
...
def patch_geocoding_cascade() -> None:
    ...
    Call this ONCE at startup in biotrace_v5.py after importing GeocodingCascade:
        ...
        from archive.geocoding_lifestage_patch import patch_geocoding_cascade
...
from archive.dedup_patch import LIFE_STAGE_TERMS, _ABBREV_GENUS_RE, _is_non_taxon  # reuse
...
from archive.dedup_patch import dedup_occurrences   # replaces gnv version
