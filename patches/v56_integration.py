...
Wiki tab usage (in your Tab 7 / wiki section):
    from .v56_integration import get_patched_wiki
...
Docling / extraction loop usage:
    from .v56_integration import get_bridge_and_cache
...
def install_v56_patches(
    ...
    try:
        from knowledge_graph.md_cache import DoclingMDCache
    ...
    if meta_db_path:
        try:
            from utils.taxon_filter import TaxonFilterWidget
