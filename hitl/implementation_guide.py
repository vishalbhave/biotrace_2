...
Add these imports near the top of biotrace_v53_2.py:
    ...
    from .ml_framework import initialize_hitl_pipeline
...
from .ml_framework import OccurrenceTypeClassifier, HITLConfig
...
from .ml_framework import SpeciesNERModel
...
from .ml_framework import LocalityNERModel
...
from .ml_framework import ActiveLearningFramework
